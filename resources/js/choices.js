  ...
  function Choices(element, userConfig) {
    ...
    if (this.passedElement.options) {
      this.passedElement.options.forEach(function (option) {
        var customProps = undefined !== option.dataset['customProperties'] ? option.dataset['customProperties'] : {};
    ...
    choicesArrayOrFetcher.forEach(function (groupOrChoice) {
      if (groupOrChoice.choices) {
        ...
        _this._addChoice({
          value: choice[value],
          label: choice[label],
          groupId: choice.groupId ? choice.groupId : -1,
    ...
    if (groupChoices) {
      ...
      var addGroupChoices = function addGroupChoices(choice) {
        ...
        _this._addChoice({
          ...
          groupId: groupId,
          customProperties: JSON.parse(choice.dataset.customProperties),
          placeholder: choice.placeholder
        });
      };
